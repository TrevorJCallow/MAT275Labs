...
for k = 1:length(OMEGA)
   ...
   Ctheory(k) = 1 / sqrt((omega0^2 - omega^2)^2 + (c * omega)^2); % FILL-IN the formula for Ctheory 
end 
figure(2) 
plot(OMEGA, C, 'b*', OMEGA, Ctheory, 'r*'); grid on; % FILL-IN to plot C and Ctheory as a function of OMEGA 
